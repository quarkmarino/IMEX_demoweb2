...
//            array('gallery_id, rank', 'numerical', 'integerOnly' => true),
    ...
    public function getImagenesDeGaleria ($galeriaId) {
    	$criteria=new CDbCriteria;
    	$criteria->addCondition('gallery_id='.$galeriaId);
    	$criteria->addCondition("((fecha_inicio IS NULL AND fecha_fin IS NULL) OR (fecha_inicio <='".date('Y-m-d'). " 00:00:00' AND fecha_fin >='".date('Y-m-d')." 23:59:59' ))");
