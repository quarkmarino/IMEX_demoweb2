			...
			<div class='contenedorLeftTopBotones' id="contenedorBotonesSeccion">
				...
				$(document).ready(function(){
					$.ajax({
						...
						'data':'portadaId=".$portadaId."&seccionId=".$secId."',
						'type':'POST',
						'cache':false,
...
<div class="contenedorInfo">
	<?php 
		echo "<div style='overflow:hidden;float:left;width:".($ancho*$cols+($cols*4))."px;'>";
			...
			echo $form->labelEx($model,'email_from');
			echo $form->textField($model,'email_from',array('size'=>45,'maxlength'=>45));
			echo $form->error($model,'email_from');
			echo "</div>";
			...
			echo $form->textArea($model,'comentario',array('cols'=>30,'rows'=>2));
